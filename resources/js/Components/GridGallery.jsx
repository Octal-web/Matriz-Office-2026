        ...
        <section className="bg-neutral-200 py-20">
            <div className="container max-w-large">
                <Reveal direction="bottom">
                    <h1 className="text-3xl sm:text-4xl 2xl:text-[44px] !leading-tight max-w-[900px] mx-auto mb-6 text-center">
                    ...
                    <div className="max-w-[1000px] mx-auto text-center text-gray-700 leading-relaxed mb-12">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 auto-rows-[300px] gap-2 md:gap-5">
