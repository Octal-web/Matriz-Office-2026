        ...
        <div className="container max-w-large">
            ...
            <Reveal direction="bottom">
                <div className="flex flex-col lg:flex-row lg:justify-between gap-6 mb-12">
                    <h2 className="text-white text-3xl sm:text-4xl font-semibold leading-tight max-w-xl">
                        Conheça os Showrooms da{' '}
                        <span className="text-neutral-400">Matriz Office</span>
                    </h2>

                    <p className="text-neutral-400 text-sm leading-relaxed max-w-md lg:text-right">
            ...
            <Reveal direction="bottom" delay={0.1}>
                <p className="text-neutral-500 text-sm leading-relaxed border-l-2 border-neutral-700 pl-5 mb-12 max-w-3xl">
